...
// Live TV channels - Proper YouTube live stream embed URLs (updated with correct video IDs)
export const LIVE_TV_CHANNELS = [
  ...
  { name: 'NDTV', icon: '🇮🇳', channelUrl: 'https://www.youtube.com/embed/RAVsW-tRiD0' },
